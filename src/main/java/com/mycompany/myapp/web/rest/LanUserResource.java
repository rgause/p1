...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.LanUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class LanUserResource {
    ...
    public ResponseEntity<LanUser> updateLanUser(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, lanUser.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<LanUser> partialUpdateLanUser(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, lanUser.getId().toString())
        );
    }
