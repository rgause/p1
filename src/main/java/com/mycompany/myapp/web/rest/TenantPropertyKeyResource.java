...
import com.mycompany.myapp.repository.TenantPropertyKeyRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TenantPropertyKey}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TenantPropertyKeyResource {
    ...
    public ResponseEntity<TenantPropertyKey> updateTenantPropertyKey(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantPropertyKey.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TenantPropertyKey> partialUpdateTenantPropertyKey(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantPropertyKey.getId().toString())
        );
    }
