...
import com.mycompany.myapp.repository.TenantPropertyRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TenantProperty}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TenantPropertyResource {
    ...
    public ResponseEntity<TenantProperty> updateTenantProperty(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantProperty.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TenantProperty> partialUpdateTenantProperty(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantProperty.getId().toString())
        );
    }
