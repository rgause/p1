...
import com.mycompany.myapp.repository.TenantTypeRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TenantType}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TenantTypeResource {
    ...
    public ResponseEntity<TenantType> updateTenantType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantType.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TenantType> partialUpdateTenantType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantType.getId().toString())
        );
    }
