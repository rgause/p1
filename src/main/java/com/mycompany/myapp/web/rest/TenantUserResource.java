...
import com.mycompany.myapp.repository.TenantUserRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TenantUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TenantUserResource {
    ...
    public ResponseEntity<TenantUser> updateTenantUser(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantUser.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TenantUser> partialUpdateTenantUser(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tenantUser.getId().toString())
        );
    }
