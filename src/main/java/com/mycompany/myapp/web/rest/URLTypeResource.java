...
import com.mycompany.myapp.repository.URLTypeRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.URLType}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class URLTypeResource {
    ...
    public ResponseEntity<URLType> updateURLType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, uRLType.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<URLType> partialUpdateURLType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, uRLType.getId().toString())
        );
    }
