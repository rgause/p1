...
import com.mycompany.myapp.repository.WorkQueueTenantDataRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkQueueTenantData}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkQueueTenantDataResource {
    ...
    public ResponseEntity<WorkQueueTenantData> updateWorkQueueTenantData(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantData.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkQueueTenantData> partialUpdateWorkQueueTenantData(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantData.getId().toString())
        );
    }
