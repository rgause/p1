...
import com.mycompany.myapp.repository.WorkQueueTenantPreReqRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkQueueTenantPreReq}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkQueueTenantPreReqResource {
    ...
    public ResponseEntity<WorkQueueTenantPreReq> updateWorkQueueTenantPreReq(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantPreReq.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkQueueTenantPreReq> partialUpdateWorkQueueTenantPreReq(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantPreReq.getId().toString())
        );
    }
