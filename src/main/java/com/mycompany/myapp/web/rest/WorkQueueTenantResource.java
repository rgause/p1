...
import com.mycompany.myapp.repository.WorkQueueTenantRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkQueueTenant}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkQueueTenantResource {
    ...
    public ResponseEntity<WorkQueueTenant> updateWorkQueueTenant(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenant.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkQueueTenant> partialUpdateWorkQueueTenant(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenant.getId().toString())
        );
    }
