...
import com.mycompany.myapp.repository.WorkQueueTenantUserDataRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkQueueTenantUserData}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkQueueTenantUserDataResource {
    ...
    public ResponseEntity<WorkQueueTenantUserData> updateWorkQueueTenantUserData(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantUserData.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkQueueTenantUserData> partialUpdateWorkQueueTenantUserData(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantUserData.getId().toString())
        );
    }
