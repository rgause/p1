...
import com.mycompany.myapp.repository.WorkQueueTenantUserPreReqRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkQueueTenantUserPreReq}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkQueueTenantUserPreReqResource {
    ...
    public ResponseEntity<WorkQueueTenantUserPreReq> updateWorkQueueTenantUserPreReq(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantUserPreReq.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkQueueTenantUserPreReq> partialUpdateWorkQueueTenantUserPreReq(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantUserPreReq.getId().toString())
        );
    }
