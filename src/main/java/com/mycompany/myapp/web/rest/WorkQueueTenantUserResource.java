...
import com.mycompany.myapp.repository.WorkQueueTenantUserRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkQueueTenantUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkQueueTenantUserResource {
    ...
    public ResponseEntity<WorkQueueTenantUser> updateWorkQueueTenantUser(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantUser.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkQueueTenantUser> partialUpdateWorkQueueTenantUser(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workQueueTenantUser.getId().toString())
        );
    }
