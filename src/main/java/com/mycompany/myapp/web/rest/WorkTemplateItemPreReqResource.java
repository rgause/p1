...
import com.mycompany.myapp.repository.WorkTemplateItemPreReqRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkTemplateItemPreReq}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkTemplateItemPreReqResource {
    ...
    public ResponseEntity<WorkTemplateItemPreReq> updateWorkTemplateItemPreReq(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workTemplateItemPreReq.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkTemplateItemPreReq> partialUpdateWorkTemplateItemPreReq(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workTemplateItemPreReq.getId().toString())
        );
    }
