...
import com.mycompany.myapp.repository.WorkTemplateItemRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkTemplateItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkTemplateItemResource {
    ...
    public ResponseEntity<WorkTemplateItem> updateWorkTemplateItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workTemplateItem.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkTemplateItem> partialUpdateWorkTemplateItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workTemplateItem.getId().toString())
        );
    }
