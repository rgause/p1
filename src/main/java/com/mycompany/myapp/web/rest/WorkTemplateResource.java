...
import com.mycompany.myapp.repository.WorkTemplateRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.WorkTemplate}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkTemplateResource {
    ...
    public ResponseEntity<WorkTemplate> updateWorkTemplate(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workTemplate.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkTemplate> partialUpdateWorkTemplate(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workTemplate.getId().toString())
        );
    }
