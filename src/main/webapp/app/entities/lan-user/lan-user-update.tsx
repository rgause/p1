  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.lanUser.home.createOrEditLabel" data-cy="LanUserCreateUpdateHeading">
            <Translate contentKey="p1App.lanUser.home.createOrEditLabel">Create or edit a LanUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('p1App.lanUser.lanId')}
                id="lan-user-lanId"
                name="lanId"
                data-cy="lanId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('p1App.lanUser.pwpId')}
                id="lan-user-pwpId"
                name="pwpId"
                data-cy="pwpId"
                type="text"
