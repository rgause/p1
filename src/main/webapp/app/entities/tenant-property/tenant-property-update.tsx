  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.tenantProperty.home.createOrEditLabel" data-cy="TenantPropertyCreateUpdateHeading">
            <Translate contentKey="p1App.tenantProperty.home.createOrEditLabel">Create or edit a TenantProperty</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('p1App.tenantProperty.value')}
              ...
              />
              <ValidatedField
                id="tenant-property-tenant"
                name="tenantId"
                data-cy="tenant"
                label={translate('p1App.tenantProperty.tenant')}
                type="select"
              >
                <option value="" key="0" />
                {tenants
              ...
              <ValidatedField
                ...
                label={translate('p1App.tenantProperty.tenantPropertyKey')}
                type="select"
              >
                <option value="" key="0" />
                {tenantPropertyKeys
