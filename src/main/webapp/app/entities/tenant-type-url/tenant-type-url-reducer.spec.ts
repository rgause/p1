...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENANTTYPEURL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TENANTTYPEURL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TENANTTYPEURL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TENANTTYPEURL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TENANTTYPEURL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TENANTTYPEURL actions', async () => {
      const expectedActions = [
        {
