  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.tenantUser.home.createOrEditLabel" data-cy="TenantUserCreateUpdateHeading">
            <Translate contentKey="p1App.tenantUser.home.createOrEditLabel">Create or edit a TenantUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('p1App.tenantUser.active')}
              ...
              />
              <ValidatedField
                id="tenant-user-lanUser"
                name="lanUserId"
                data-cy="lanUser"
                label={translate('p1App.tenantUser.lanUser')}
                type="select"
              >
                <option value="" key="0" />
                {lanUsers
              ...
              <ValidatedField
                id="tenant-user-tenant"
                name="tenantId"
                data-cy="tenant"
                label={translate('p1App.tenantUser.tenant')}
                type="select"
              >
                <option value="" key="0" />
                {tenants
