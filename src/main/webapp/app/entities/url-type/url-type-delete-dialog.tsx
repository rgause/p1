...
export const URLTypeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="p1App.uRLType.delete.question">
        <Translate contentKey="p1App.uRLType.delete.question" interpolate={{ id: uRLTypeEntity.id }}>
          Are you sure you want to delete this URLType?
        </Translate>
      </ModalBody>
      <ModalFooter>
