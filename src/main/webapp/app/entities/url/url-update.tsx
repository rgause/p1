  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.uRL.home.createOrEditLabel" data-cy="URLCreateUpdateHeading">
            <Translate contentKey="p1App.uRL.home.createOrEditLabel">Create or edit a URL</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="url-urlType" name="urlTypeId" data-cy="urlType" label={translate('p1App.uRL.urlType')} type="select">
                <option value="" key="0" />
                {uRLTypes
              ...
              <ValidatedField id="url-tenant" name="tenantId" data-cy="tenant" label={translate('p1App.uRL.tenant')} type="select">
                <option value="" key="0" />
                {tenants
