  ...
  return (
    <div>
      <h2 id="url-heading" data-cy="URLHeading">
        <Translate contentKey="p1App.uRL.home.title">URLS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> <Translate contentKey="p1App.uRL.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="p1App.uRL.home.createLabel">Create new URL</Translate>
          </Link>
        </div>
      </h2>
        ...
        {uRLList && uRLList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="p1App.uRL.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="p1App.uRL.url">Url</Translate>
                </th>
                <th>
                  <Translate contentKey="p1App.uRL.urlType">Url Type</Translate>
                </th>
                <th>
                  <Translate contentKey="p1App.uRL.tenant">Tenant</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="p1App.uRL.home.notFound">No URLS found</Translate>
            </div>
          )
        )}
      </div>
