  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.workQueueTenantPreReq.home.createOrEditLabel" data-cy="WorkQueueTenantPreReqCreateUpdateHeading">
            <Translate contentKey="p1App.workQueueTenantPreReq.home.createOrEditLabel">Create or edit a WorkQueueTenantPreReq</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  required
                  readOnly
                  id="work-queue-tenant-pre-req-id"
                  label={translate('global.field.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('p1App.workQueueTenantPreReq.preRequisiteItem')}
              ...
              <ValidatedField
                ...
                label={translate('p1App.workQueueTenantPreReq.workQueueItem')}
                type="select"
              >
                <option value="" key="0" />
                {workQueueTenants
