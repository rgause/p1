  ...
  return (
    <div>
      <h2 id="work-queue-tenant-user-data-heading" data-cy="WorkQueueTenantUserDataHeading">
        <Translate contentKey="p1App.workQueueTenantUserData.home.title">Work Queue Tenant User Data</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="p1App.workQueueTenantUserData.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="p1App.workQueueTenantUserData.home.createLabel">Create new Work Queue Tenant User Data</Translate>
          </Link>
        </div>
      </h2>
        ...
        {workQueueTenantUserDataList && workQueueTenantUserDataList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="p1App.workQueueTenantUserData.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="p1App.workQueueTenantUserData.home.notFound">No Work Queue Tenant User Data found</Translate>
            </div>
          )
        )}
      </div>
