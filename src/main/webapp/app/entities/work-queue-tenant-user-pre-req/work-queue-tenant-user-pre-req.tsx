  ...
  return (
    <div>
      <h2 id="work-queue-tenant-user-pre-req-heading" data-cy="WorkQueueTenantUserPreReqHeading">
        <Translate contentKey="p1App.workQueueTenantUserPreReq.home.title">Work Queue Tenant User Pre Reqs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="p1App.workQueueTenantUserPreReq.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="p1App.workQueueTenantUserPreReq.home.createLabel">Create new Work Queue Tenant User Pre Req</Translate>
          </Link>
        </div>
      </h2>
        ...
        {workQueueTenantUserPreReqList && workQueueTenantUserPreReqList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="p1App.workQueueTenantUserPreReq.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="p1App.workQueueTenantUserPreReq.home.notFound">No Work Queue Tenant User Pre Reqs found</Translate>
            </div>
          )
        )}
      </div>
