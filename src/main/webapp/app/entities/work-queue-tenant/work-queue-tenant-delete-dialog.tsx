...
export const WorkQueueTenantDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="p1App.workQueueTenant.delete.question">
        <Translate contentKey="p1App.workQueueTenant.delete.question" interpolate={{ id: workQueueTenantEntity.id }}>
          Are you sure you want to delete this WorkQueueTenant?
        </Translate>
      </ModalBody>
      <ModalFooter>
