  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.workQueueTenant.home.createOrEditLabel" data-cy="WorkQueueTenantCreateUpdateHeading">
            <Translate contentKey="p1App.workQueueTenant.home.createOrEditLabel">Create or edit a WorkQueueTenant</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  required
                  readOnly
                  id="work-queue-tenant-id"
                  label={translate('global.field.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('p1App.workQueueTenant.task')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workQueueTenant.requiredToComplete')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workQueueTenant.dateCreated')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workQueueTenant.dateCancelled')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workQueueTenant.dateCompleted')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workQueueTenant.sequenceOrder')}
              ...
              />
              <ValidatedField
                id="work-queue-tenant-tenant"
                name="tenantId"
                data-cy="tenant"
                label={translate('p1App.workQueueTenant.tenant')}
                type="select"
              >
                <option value="" key="0" />
                {tenants
