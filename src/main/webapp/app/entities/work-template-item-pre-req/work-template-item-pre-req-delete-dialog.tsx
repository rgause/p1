...
export const WorkTemplateItemPreReqDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="p1App.workTemplateItemPreReq.delete.question">
        <Translate contentKey="p1App.workTemplateItemPreReq.delete.question" interpolate={{ id: workTemplateItemPreReqEntity.id }}>
