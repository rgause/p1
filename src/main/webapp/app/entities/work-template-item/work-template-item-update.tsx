  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="p1App.workTemplateItem.home.createOrEditLabel" data-cy="WorkTemplateItemCreateUpdateHeading">
            <Translate contentKey="p1App.workTemplateItem.home.createOrEditLabel">Create or edit a WorkTemplateItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  required
                  readOnly
                  id="work-template-item-id"
                  label={translate('global.field.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('p1App.workTemplateItem.task')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workTemplateItem.requiredToComplete')}
              ...
              />
              <ValidatedField
                label={translate('p1App.workTemplateItem.sequenceOrder')}
              ...
              <ValidatedField
                ...
                label={translate('p1App.workTemplateItem.workTemplate')}
                type="select"
              >
                <option value="" key="0" />
                {workTemplates
