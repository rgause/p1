  ...
  return (
    <div>
      <h2 id="work-template-item-heading" data-cy="WorkTemplateItemHeading">
        <Translate contentKey="p1App.workTemplateItem.home.title">Work Template Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="p1App.workTemplateItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="p1App.workTemplateItem.home.createLabel">Create new Work Template Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {workTemplateItemList && workTemplateItemList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="p1App.workTemplateItem.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="p1App.workTemplateItem.home.notFound">No Work Template Items found</Translate>
            </div>
          )
        )}
      </div>
