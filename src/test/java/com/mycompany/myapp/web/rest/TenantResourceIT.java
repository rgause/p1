...
class TenantResourceIT {
    ...
    public static Tenant createEntity(EntityManager em) {
        Tenant tenant = new Tenant().name(DEFAULT_NAME).active(DEFAULT_ACTIVE);
        return tenant;
    }
    ...
    public static Tenant createUpdatedEntity(EntityManager em) {
        Tenant tenant = new Tenant().name(UPDATED_NAME).active(UPDATED_ACTIVE);
        return tenant;
    }
    ...
    void putNewTenant() throws Exception {
        ...
        updatedTenant.name(UPDATED_NAME).active(UPDATED_ACTIVE);
    ...
    void fullUpdateTenantWithPatch() throws Exception {
        ...
        partialUpdatedTenant.name(UPDATED_NAME).active(UPDATED_ACTIVE);
