...
class TenantUserResourceIT {
    ...
    public static TenantUser createEntity(EntityManager em) {
        TenantUser tenantUser = new TenantUser().active(DEFAULT_ACTIVE);
        return tenantUser;
    }
    ...
    public static TenantUser createUpdatedEntity(EntityManager em) {
        TenantUser tenantUser = new TenantUser().active(UPDATED_ACTIVE);
        return tenantUser;
    }
    ...
    void putNewTenantUser() throws Exception {
        ...
        updatedTenantUser.active(UPDATED_ACTIVE);
